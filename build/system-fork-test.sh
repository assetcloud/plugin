...
NODE1="${1}_chain31_1"
CLI3="docker exec ${NODE1} /root/chain-cli"
...
NODE6="${1}_chain28_1"
CLI6="docker exec ${NODE6} /root/chain-cli"
...
function base_init() {
    ...
    # p2p
    sed -i $sedfix 's/^seeds=.*/seeds=["chain:13802","chain32:13802","chain31:13802","chain30:13802","chain29:13802","chain28:13802"]/g' chain.toml
