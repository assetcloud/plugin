...
package="chain_tendermint_config.tar.gz"
...
GetInputFile() {
    echo 'Please input the file: (such as "chain chain-cli genesis.json" ...) '
    read file
...
GetUserNamePasswdAndPath() {
    ...
    read choice
    if [ "${choice}" -eq 1 ]; then
        echo 'Please input the username, password and path of the destination: (such as "ubuntu 123456 /home/ubuntu/chain")'
