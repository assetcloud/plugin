...
func createConn(url string) (*grpc.ClientConn, types.ChainClient, error) {
	var err error
	//url := "127.0.0.1:8802"
...
func sendRegistCandidatorTx(cfg *types.ChainConfig, ppubkey, addr, ip, privKey string) bool {
