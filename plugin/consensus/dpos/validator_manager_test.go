...
func TestMakeGenesisValidatorMgr(t *testing.T) {
	...
	require.Nil(t, err)
	assert.True(t, vMgr.ChainID == "chain-Z2cgFj")
	...
	vMgrCopy := vMgr.Copy()
	assert.True(t, vMgrCopy.ChainID == "chain-Z2cgFj")
