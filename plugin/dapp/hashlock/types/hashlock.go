...
// NewType method
func NewType(cfg *types.ChainConfig) *HashlockType {
	c := &HashlockType{}
	c.SetChild(c)
	c.SetConfig(cfg)
	return c
...
func CreateRawHashlockLockTx(cfg *types.ChainConfig, parm *HashlockLockTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawHashlockUnlockTx(cfg *types.ChainConfig, parm *HashlockUnlockTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawHashlockSendTx(cfg *types.ChainConfig, parm *HashlockSendTx) (*types.Transaction, error) {
	if parm == nil {
