...
function AllRelayerMainTest() {
    set +e
    #    docker cp ${GOPATH}/src/github.com/assetcloud/plugin/build/ci/x2ethereum build_chain33_1:/root/x2ethereum
    #    docker cp ${GOPATH}/src/github.com/assetcloud/plugin/plugin/dapp/x2ethereum/cmd/build/RopstenTest.sh build_chain33_1:/root/x2ethereum/RopstenTest.sh
