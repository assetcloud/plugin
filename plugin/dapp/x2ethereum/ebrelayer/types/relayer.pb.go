...
type ValidatorAddr4EthRelayer struct {
	ChainValidator string `protobuf:"bytes,1,opt,name=chainValidator" json:"chainValidator,omitempty"`
}
...
type EthBridgeClaim struct {
	...
	ChainReceiver string `protobuf:"bytes,7,opt,name=chainReceiver" json:"chainReceiver,omitempty"`
...
type NewProphecyClaim struct {
	...
	ChainSender string `protobuf:"bytes,2,opt,name=chainSender" json:"chainSender,omitempty"`
...
type LockEthErc20 struct {
	...
	ChainReceiver string `protobuf:"bytes,4,opt,name=chainReceiver" json:"chainReceiver,omitempty"`
}
