...
// NewType  new type
func NewType(cfg *types.ChainConfig) *GameType {
	c := &GameType{}
	c.SetChild(c)
	c.SetConfig(cfg)
	return c
...
func CreateRawGamePreCreateTx(cfg *types.ChainConfig, parm *GamePreCreateTx) (*types.Transaction, error) {
	if parm == nil {
...
func CreateRawGamePreMatchTx(cfg *types.ChainConfig, parm *GamePreMatchTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
...
func CreateRawGamePreCancelTx(cfg *types.ChainConfig, parm *GamePreCancelTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
	v := &GameCancel{
...
func CreateRawGamePreCloseTx(cfg *types.ChainConfig, parm *GamePreCloseTx) (*types.Transaction, error) {
	if parm == nil {
		return nil, types.ErrInvalidParam
	}
	v := &GameClose{
