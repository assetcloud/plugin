...
例如paracross copy到chain/build/ci/paracross目录下
...
测试执行完后相应dockers不会自动删除，还可以通过docker exec build_chain_1 /root/chain-cli [cmd...] 来查看信息
...
build下的文件都是和CI 测试相关的
 ...
 1. docker-compose yml文件是组织docker service编排的，chain至少需要启动2个docker才能挖矿，如果对Dockerfile 命名有修改，可以在
